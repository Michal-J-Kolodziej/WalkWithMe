...
5.  **Double-Check Logic (Critical):**
    ...
    - _Ask yourself:_ "What happens if the user is offline? What if this field is null? Is this secure?"
...
2.  **API Logic:**
    ...
    - _Self-Correction:_ Check for missing exports or logic errors immediately.
...
2.  **Component Creation:**
    ...
    - _Check:_ Do imports exist? (e.g., icons, UI primitives like `Avatar`). Install dependencies if missing.
3.  **Integration:**
